    ...
    <div class="col-sm-12">
        ...
        <section class="panel">
            <header class="panel-heading head-border">
                {{ labelkey['reportpupil.lbl_attitude']~' '~labelkey['classobj.lbl_form']~' '~classobj.name~' <b>('~date('d-m-Y',_GET['datetest'])~')</b>'}}
            </header>
                            ...
                            <div class="col-sm-4 panel">
                                ...
                                <div class="clearfix">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9"><input type="text" value="{{ item.attendance }}" name="attendance[{{ item.id }}]" class="form-control" placeholder="{{ labelkey['reportpupil.lbl_attendance'] }}" required></div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">{{ labelkey['reportpupil.lbl_participation'] }}</label>

                                        <div class="col-md-9"><input type="text" value="{{ item.participation }}" name="participation[{{ item.id }}]" class="form-control" placeholder="{{ labelkey['reportpupil.lbl_participation'] }}" required></div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">{{ labelkey['reportpupil.lbl_behavior'] }}</label>

                                        <div class="col-md-9"><input type="text" value="{{ item.behavior }}" name="behavior[{{ item.id }}]" class="form-control" placeholder="{{ labelkey['reportpupil.lbl_behavior'] }}" required></div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">{{ labelkey['reportpupil.lbl_diligence'] }}</label>

                                        <div class="col-md-9"><input type="text" value="{{ item.diligence }}" name="diligence[{{ item.id }}]" class="form-control" placeholder="{{ labelkey['reportpupil.lbl_diligence'] }}" required></div>
                                    </div>
                                </div>
                            </div>
                        {% endfor %}
