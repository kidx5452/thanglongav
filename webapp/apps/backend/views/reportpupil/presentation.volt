<div class="row">
    ...
    <header class="panel-heading">
        {{ labelkey['reportpupil.lbl_presentation'] }} <a href="/reportpupil/index?id={{ _GET['userid'] }}"><strong class="text-danger">{{ userinfo.username }}</strong></a>
    </header>
...
<script>
    $('.addmoretemplate').click(function () {
        $.get('{{ url('/reportpupil/gettemplate') }}', {type: 'presentation'}, function (re) {
