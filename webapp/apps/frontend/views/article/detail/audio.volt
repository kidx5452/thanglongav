            ...
            <div class="sidebar-left col-md-9 col-sm-8 col-xs-12">
                ...
                <div class="bg-news">
                    <article class="thumbnail-music-view">
                                ...
                                <div class="list-music-info">
                                    <ul>
									  ...
									  <span class="bold">
                                        ...
                                        <li>
									  <span class="bold">
										<span class="shape"><i class="fa fa-music"></i></span>Số bài hát:
									  </span> {{ object.data.countmedia }}
                                        </li>
                                        <li>
									  <span class="bold">
										<span class="shape"><i class="fa fa-microphone"></i></span>Ca sĩ:
									  </span> {{ object.data.captions }}
                                        </li>
                                        <li>
									  <span class="bold">
                        ...
                        <div class="row clear">
                            <div class="heading-catagories mb-20"><h2>Audio khác</h2></div>
