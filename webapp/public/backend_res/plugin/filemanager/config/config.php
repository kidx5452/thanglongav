...
//define('_ROOT_' , dirname(dirname(dirname(dirname(__FILE__)))));
define('_ROOT_' , "/home/wsi.vn/public_html/public");
...
$config = array(
	...
	*/
	...
	//'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'],
        'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . "wsi.vn",
	...
	*/
	...
	|
	*/
	'thumbs_base_path' => _ROOT_ . '/thumbs/',
